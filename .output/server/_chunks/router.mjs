...
var styles_default = "/assets/styles-Dp8Lu1gk.css";
//#endregion
...
var Route = createFileRoute("/")({
	head: () => ({ meta: [
		...
		{
			name: "description",
			content: "Motus Research is an unfiltered AI platform. Import Chai bots instantly or build your own unrestricted characters. Zero filters. Zero latency."
		},
		{
			property: "og:title",
			content: "Motus Research — Unfiltered AI"
		},
		{
			property: "og:description",
			content: "The raw power of Chai's AI engine, stripped of filters. Bring your own bots or discover community favorites."
		}
	] }),
	component: Landing
});
